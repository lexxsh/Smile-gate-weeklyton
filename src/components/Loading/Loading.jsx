...
const Loading = () => {
  return (
    <div className="Loading-container">
      <div className="wrapper">
        ...
        >
          <defs>
            <style>
              {`
              .avocado-1 { fill: #637b00; }
              .avocado-2 { opacity: 0.3; }
              .avocado-3 { fill: #dfe264; }
              .avocado-4 { fill: #bfa34c; }
              .avocado-5 { opacity: 0.2; }
              .avocado-6 { fill: #191919; }
              .avocado-7 { opacity: 0.1; }
            `}
            </style>
          </defs>
          <title>avocado</title>
      ...
      <div className="Loading-text">적어주신 일기를 꼼꼼히 읽고 있어요!</div>
      <div className="Loading-text2">조금만 기다려주세요!</div>
    </div>
  )
}
